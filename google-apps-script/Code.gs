// Obtém o ID da pasta do Google Drive através das Propriedades do Script (segurança)
var FOLDER_ID = PropertiesService.getScriptProperties().getProperty('DRIVE_FOLDER_ID');
